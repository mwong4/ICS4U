...
\addtolength{\jot}{1em}
\begin{align*}
    RHS &= 1-\dfrac{\sin^3(x)}{\sin(x) + \cos(x)} - \dfrac{\cos^3(x)}{\sin(x) + \cos(x)} \\
    &= \dfrac{\sin(x)+\cos(x)}{\sin(x)+\cos(x)}-\dfrac{\sin^3(x)}{\sin(x) + \cos(x)} - \dfrac{\cos^3(x)}{\sin(x) + \cos(x)} && 1 = \dfrac{\sin(x)+\cos(x)}{\sin(x)+\cos(x)} \\
    &= \dfrac{\sin(x)+\cos(x) - \sin^3(x) - \cos^3(x)}{\sin(x)+\cos(x)} && \text{Add together} \\
...
\begin{align*}
    ...
    &= \cos^2(2x) - \sin^2(2x) && \text{Double Angle Iden. for cosine,} \theta=4x\\
    &= (\cos^2(x) - \sin^2(x))^2 - \sin^2(2x) && \text{Double Angle Iden. for cosine,} \theta=2x\\
    &= (\cos^2(x) - \sin^2(x))^2 - (2\sin(x)\cos(x))^2 && \text{Double Angle Iden. for sine,} \theta=2x\\
    &= \cos^4(x) - 2\sin(x)^2\cos(x)^2 + \sin^4(x) - 4\sin(x)^2\cos(x)^2 && \text{Apply exponents}\\
    \therefore \cos(4x) &= \cos^4(x) + \sin^4(x) - 6\sin^2(x)\cos^2(x) && \text{Simplify}
\end{align*}
