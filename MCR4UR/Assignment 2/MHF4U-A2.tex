...
$$\boxed{\therefore \text{the intervals that satisfy the inequality} \bigg|\dfrac{x-4}{x+5}\bigg| \le 4 \text{ are } (-\infty , -8] \text{ and } \left[ -\dfrac{16}{5}, \infty \right) \text{.}}$$

\textbf{Prove the intervals found with a graph:}

\begin{center}
\includegraphics[scale = 0.5]{A2-5 Proof.PNG}
\end{center}
