...
void bubbleSort(int _elements[], int _size)
{
    ...
    for(int i = 1; i < _size; i++) //Manages comparisons in pass
    {
...
void insertionSort(int _elements[], int _size)
{
    ...
    while(_elements[5-counter] < _elements[4-counter]) //If element to the left of "target" is larger, swap
    {
        //swap values
        tempInt = _elements[4-counter];
        _elements[4-counter] = _elements[5-counter];
        _elements[5-counter] = tempInt;
...
{
    int smallest = _elements[1]; //Tracks the smallest value found
    int smallestPos = 1; //Tracks the smallest value location
    int tempInt; //temporary integer for swapping

    //Where i = 1

    for(int j = 1; j < _size; j++) //Go through and find smallest
    {
    ...
    //swap values
    tempInt = smallest;
    _elements[smallestPos] = _elements[1];
    _elements[1] = tempInt;
